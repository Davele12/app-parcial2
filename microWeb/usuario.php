...
<body>
    ...
    <div class="container-fluid">
        <a class="navbar-brand" href="usuario.php">Plan y Viajar</a>
    ...
    <thead>
        ...
        <th scope="col">"1" para agregar</th>
    ...
    <?php
     ...
     ?>
        ...
        <td><?php echo '<input type="number" name="capacidad['.$id.']" value="0" min="0">';?></td>
        </tr>
     <?php  } ?>  
    ...
    <input type="submit" value="Agregar al plan">
    </form>
    </body>
</html>